...
'Nama Lengkap'
Mobile.setText(findTestObject('Register/android.widget.EditText - New Name'), 'TESTER2', 0, FailureHandling.STOP_ON_FAILURE)

'No.Ponsel'
Mobile.setText(findTestObject('Register/android.widget.EditText - Phone Number'), '0819555831', 0, FailureHandling.STOP_ON_FAILURE)

'Email'
Mobile.setText(findTestObject('Register/android.widget.EditText - NEW EMAIL'), 'test0000test12@gmail.com', 0, FailureHandling.STOP_ON_FAILURE)
...
'Confirmation nama lengkap'
Mobile.getText(findTestObject('Register/android.widget.TextView - Penulisan nama tidak sesuai'), 0, FailureHandling.STOP_ON_FAILURE)

'Take screenshot of current device screen'
Mobile.takeScreenshot("D:\\screenshot1-3.png")
