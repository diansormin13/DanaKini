...
'conr. password'
Mobile.sendKeys(findTestObject('Register/android.widget.EditText - CONR PASSWORD'), 'ASDasd1234')
...
'Confirmation unequal passwords\r\n'
Mobile.getText(findTestObject('Register/android.widget.TextView - Konfirmasi kata sandi tidak sama'), 0, FailureHandling.STOP_ON_FAILURE)

'Take screenshot of current device screen'
Mobile.takeScreenshot("D:\\screenshot1-4.png")
