...
'Nama Lengkap'
Mobile.setText(findTestObject('Register/android.widget.EditText - New Name'), 'TESTER KITA', 0, FailureHandling.STOP_ON_FAILURE)

'No.Ponsel'
Mobile.setText(findTestObject('Register/android.widget.EditText - Phone Number'), '087456887789654', 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.getText(findTestObject('Register/android.widget.TextView - Email  No Ponsel Anda sudah terdaftar'), 0, FailureHandling.STOP_ON_FAILURE)

'Take screenshot of current device screen'
Mobile.takeScreenshot("D:\\screenshot1-2.png")
