...
'Nama Lengkap'
Mobile.setText(findTestObject('Register/android.widget.EditText - New Name'), 'TESTERsR', 0, FailureHandling.STOP_ON_FAILURE)

'No.Ponsel'
Mobile.setText(findTestObject('Register/android.widget.EditText - Phone Number'), '0819555832', 0, FailureHandling.STOP_ON_FAILURE)

'Email'
Mobile.setText(findTestObject('Register/android.widget.EditText - NEW EMAIL'), 'test0000test1236@gmail.com', 0, FailureHandling.STOP_ON_FAILURE)
...
'declaration OTP'
Mobile.getText(findTestObject('Register/android.widget.TextView - Silahkan Input Kode OTP 6-digit yang kami kirimkan lewat SMS'), 
    0, FailureHandling.STOP_ON_FAILURE)

'Take screenshot of current device screen'
Mobile.takeScreenshot("D:\\screenshot1-6.png")
